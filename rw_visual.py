...
while True:
    ...
    fig, ax = plt.subplots(figsize=(10, 6))  # figsize = size of the plot in inches
    points_numbers = range(rw.num_points)  # a list of numbers from 0 to number of points in the walk-1
